...
class WorkflowService:
    ...
    def update(*, user, workspace_id, workflow_id, name):
        ...
        if (
            ...
            raise ValidationError({"detail": "This workflow already exists."})
        workflow.name = name
...
class WorkflowStatusService:
    ...
    def create(*, user, workflow_id, data):
        ...
        if WorkflowStatus.objects.filter(workflow=workflow, order=order).exists():
            raise ValidationError(
