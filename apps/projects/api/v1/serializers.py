...
from ...models import Status, Workflow, Project, WorkflowStatus
...
class ProjectListSerializer(serializers.ModelSerializer):
    workspace_id = serializers.CharField(source="workspace.id",
                                                read_only=True)
    workflow_id = serializers.CharField(source="workflow.id",
                                        read_only=True)
